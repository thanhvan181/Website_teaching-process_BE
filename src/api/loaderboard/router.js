...
router.route('/:leaderboardId/questionleaderboard').patch(updateQuestionLeaderboard);

router.route('/:leaderboardId/currentleaderboard').patch(updateCurrentLeaderboard);
